...
import { FaceTecInitializationError, FaceTecSessionResult, type FaceTecSDKInstance } from "../10.0.42/core-sdk/FaceTecSDK.js/FaceTecPublicApi";
...
export class SampleAppController {
  ...
  public onLivenessCheckPressed = (): void => {
    ...
    // console.log("no onLivenessCheckPressed")
